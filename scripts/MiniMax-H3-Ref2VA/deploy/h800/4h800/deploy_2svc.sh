...
echo "  NUM_SERVICES=2 PORT_BASE=9000 bash ../../generate/generate_768p_fanout.sh 2>/dev/null ||"
echo "  NUM_SERVICES=2 PORT_BASE=9000 bash ../../generate/generate_480p_fanout.sh"
