...
> 客户端 `../../generate/generate_480p_5s_nsvc.sh`(`NUM_SERVICES` / `PORT_BASE` 控制)。
...
压测:`NUM_SERVICES=N PORT_BASE=9000 bash ../../generate/generate_480p_5s_nsvc.sh`
(单路 `NUM_SERVICES=1`,或 `generate_480p_5s.sh`)。
